...
const { getMyPatients, linkPatient, getPatientDashboard } = require("../controllers/caregiverController");
...
router.post("/link-patient", protect, authorizeRoles("caregiver"), linkPatient);
